...
plt.tight_layout()
if args.attack:
    plt.savefig(f"heatmap_{args.algo}_attack_myopic.png", dpi=300, bbox_inches='tight')
else:
    plt.savefig(f"heatmap_{args.algo}_myopic.png", dpi=300, bbox_inches='tight')
...
if args.attack:
    ...
    # plt.title(f"Action Distribution Heatmap (Mean ± Std): {args.algo}")
    plt.tight_layout()
    plt.savefig(f"heatmap_{args.algo}_after_attack_myopic.png", dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(f"heatmap_{args.algo}_diff_myopic.png", dpi=300, bbox_inches='tight')
