...
def get_config():
    ...
    parser.add_argument('--attacker', action='store_true', help='whether to train for attacker')    # parser.add_argument('--wandb', type=bool, default=False, help='whether to use wandb logging')
    ...
    parser.add_argument('--episode', type=float, default=0.03, help='扰动强度')
